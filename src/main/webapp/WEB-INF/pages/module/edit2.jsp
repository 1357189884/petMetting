...
<html>
    ...
    <body>
        <form class="form-inline definewidth m20" action="index.html" method="get">
            ...
            &nbsp;&nbsp;
            <button type="submit" class="btn btn-primary" onClick="formSubmit('editM2','_self');this.blur();">
                修改
            </button>
            &nbsp;&nbsp;
        ...
        <table class="table table-bordered table-hover definewidth m10">
            ...
            <tr>
                ...
                <td>${m.remark}</td>
             <td>
			<c:if test="${m.state==1}"><a href="stop.action?moduleId=${m.moduleId}"><font color="green">启用</font></a></c:if>
			<c:if test="${m.state==0}"><a href="start.action?moduleId=${m.moduleId}"><font color="red">停用</font></a></c:if>
		</td>
            </tr>
            </c:forEach>
        </table>
